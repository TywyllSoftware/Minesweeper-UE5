 ...
 */
class FMinesweeperToolbarModule : public IModuleInterface
{
public:
...
private:
    ...
    void PlayNewGameClicked();
    
private:

    TSharedPtr<FUICommandList> m_UtilMenuCommandList;
    TSharedPtr<FExtender> m_MyExtender;
};
